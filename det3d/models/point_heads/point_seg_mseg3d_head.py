...
class PointSegMSeg3DHead(nn.Module):
    def __init__(self, class_agnostic, num_class, model_cfg, **kwargs):
        ...
        # TODO: KHANH ADD module to resize range features
        range_align_channels = model_cfg["RANGE_ALIGN_DIM"]
        range_in_channels = model_cfg["RANGE_IN_DIM"]
        self.gffm_range = nn.Sequential(
            nn.Linear(range_in_channels, range_align_channels),
            norm_layer(range_align_channels),
            act_layer(),
        ) 
        # KHANH ADD
        ...
        self.gffm_lc = nn.Sequential(
            nn.Linear(voxel_align_channels + image_align_channels + range_align_channels, fused_channels),
    ...
    def forward(self, batch_dict, return_loss=True, **kwargs):
        ...
        #print('size of points:', point_coords.size())
        # voxel features -> point lidar features 
        ...
        # print('size point features lidar:', point_features_lidar.size())
        ...
        #print('point_features_camera_0 shape:', point_features_camera_0.size())
        ...
        #print('point feature camera_pad0 shape before:', point_features_camera_pad0.size())
        ...
        # TODO: KHANH ADD get range features, range_pxpy
        # from SegMSeg class
        range_features = batch_dict['range_features']
        range_pxpy = batch_dict['range_pxpy']
        
        # Get point-wise range features
        point_features_range_0 = range_to_point(range_features, range_pxpy)

        # Resize point-wise range features to get 64 cols
        point_features_range = self.gffm_range(point_features_range_0)
