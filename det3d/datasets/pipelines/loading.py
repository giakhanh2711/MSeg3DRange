...
from OpenPCSeg.pcseg.data.dataset.semantickitti.semantickitti_utils import color_map
from OpenPCSeg.pcseg.data.dataset.semantickitti.semantickitti_rv import SemkittiRangeViewDataset
from OpenPCSeg.tools.utils.train.config import cfgs, cfg_from_yaml_file
...
class LoadPointCloudFromFile(object):
    ...
    def __call__(self, res, info):
        ...
        # nusc seg3d
            ...
            # # TODO: KHANH ADD
            # lidar_path = Path('/home/nnthao02/Linh_Khanh/data/SemanticNusc') / lidar_path
            # # KHANH ADD
...
class LoadImageFromFile(object):
    ...
    def __call__(self, res, info):
        ...
        if dataset_type == "NuScenesDataset":
            ...
            # # TODO: KHANH ADD
            # cam_path = Path('/home/nnthao02/Linh_Khanh/data/SemanticNusc') / cam_path
            # # KHANH ADD
